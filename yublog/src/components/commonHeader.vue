<template>
  <header  style="position:sticky">
    <div class="wrapper">
      <el-row>
        <el-col :xs="20" :sm="4" :md="4" :lg="4" :xl="4"><div class="logo"></div></el-col>
...
header{
  background: #2d2d2d;
  color: #9d9d9d;
  box-shadow: 0 2px 4px 1px rgba(151, 146, 146, 0.5);
  margin-bottom: 10px;
  .logo {
    line-height: 40px;
    font-size: 16px;
  ...
  .nav-mob {
    ...
    .content {
      ul {
        ...
        box-shadow: 0px 3px 4px 1px rgba(137, 131, 131, 0.5);
        li {
